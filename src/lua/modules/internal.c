...
l_enable_table_gc (lua_State *L)
{
    ...
    luaL_argcheck (
        L, luaL_getmetafield (L, 1, "__gc"), 1,
        E_ ("The table doesn't have a metatable, or its metatable doesn't have a '__gc' field."));
 ...
 */
static int
l_request_lua_restart (MC_UNUSED lua_State *L)
{
