...
ui.Dialog.bind('<<open>>', function(dlg)
  if dlg.text == T'Copy' then
    dlg:find('Checkbox', 3):focus()  -- focus some checkbox (to demonstrate 'dfocus').
...
local function shoot_panel_long()
  ui.Panel.current.list_format = "long"
