...
void luaUI_push_widget_ex (lua_State *L, Widget *w, gboolean created_in_c, gboolean allow_abstract);
...
cb_ret_t call_widget_method (Widget *w, const char *method_name, int nargs, gboolean *method_found);
